...
namespace BlockBase.Dapps.CloudManager.WebApp.Helpers
{
    public static class HttpHelper
    {
        ...
        public static HttpWebRequest ComposeWebRequestPost(string url, Dictionary<string, string> queryStrings) => ComposeWebRequest(url, queryStrings, "POST");
        public static HttpWebRequest ComposeWebRequestGet(string url, Dictionary<string, string> queryStrings) => ComposeWebRequest(url, queryStrings, "GET");
